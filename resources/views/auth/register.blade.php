            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                         ...
                         {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="customRadioInline1">Konsument</label>
                                  </div>
                                  <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Potwtórz hasło') }}</label>
