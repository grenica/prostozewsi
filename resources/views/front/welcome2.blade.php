    ...
    {{-- <div id="app"> --}}
        ...
        <main class="main_start">
            <div class="info_start">
                <h3>Witaj na targu prawdziwej żywności</h3>
                <h4>Szanuj swoję zdrowie, pieniądze i ludzi którzy tworzą żywność dla Ciebie</h5>
                    <a href="#" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#exampleModal">Najbliższy baraz</a>
            </div>
