                       ...
                       <thead>
                        ...
                        <tbody>
                            @foreach ($features as $feature)
                                ...
                                <a class="btn btn-outline-info edit" data-id="{{ $feature->id }}"><i class="icofont-ui-edit"></i></a>                               
                                {!! Form::model($feature,array('route'=>['admin.feature.destroy',$feature],'method'=>'DELETE','class'=>'d-inline')) !!}
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Dodaj nową cechę</h5>
...
$(document).ready(function() {
  ...
  $('#form').on('submit', function(e){
      ...
      if(state == '') {
        action_url = "{{ route('admin.feature.store') }}";
        metoda = "POST";
      } else {
        action_url = '/admin/feature/'+state;
        metoda = "PUT";
      }
        $.ajax({
          data: $('#form').serialize(),
