...
<div class="container">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <h3 class="card-title">Kategoria główna: {{ $category->name }}</h3>
        </div>
          <div class="card-body">
                       ...
                       <thead>
                        ...
                        <tbody>
                            @foreach ($category->children as $cat)
                                ...
                                <a class="btn btn-outline-info edit" data-id="{{ $cat->id }}"><i class="icofont-ui-edit"></i></a>                               
                                {!! Form::model($cat,array('route'=>['admin.category.destroy',$cat],'method'=>'DELETE','class'=>'d-inline')) !!}
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Dodaj podkategorię</h5>
